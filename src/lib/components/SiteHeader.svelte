  ...
  <div class="flex items-center w-full h-full page-container">
    <div class="flex justify-start {isHomePage ? 'max-lg:flex-1' : 'flex-1'}">
      <a href="/" class="flex items-center gap-2">
        <img src="/images/co2024-logo_topleft.png" class="h-12" alt="DGPT Europe - Copenhagen Open 2024" class="mt-8 fixed h-16" />
        {#if !isHomePage}
                      ...
                      <div>
                        ...
                        <div class="grid grid-cols-2 gap-3 p-1 sm:grid-cols-3">
                          {#each subnav.items as item}
                            ...
                            >
                              <div class="text-sm font-bold leading-none sm:text-base">
                                {item.label}
                              </div>
                              <p
                                class="text-xs leading-snug line-clamp-1 text-muted-foreground sm:line-clamp-2 sm:text-sm"
                              >
                                {item.description}
                              </p>
                            </a>
