<h1>Course</h1>
<p>
    The course is a varied and challenging course featuring both long, open and narrow holes, plus a few smaller hills and 2 elevated baskets. The par for the course is 64 with a total length of 2667 meters for the MPO division, and par 66 and 2466 meters for the FPO division.<br /><br />
    ...
    <i>Note: THIS YEAR the paving stones between the grass and the road on the right side of hole 14 - left side of holes 12 / 13 - <b>ARE OB</b>!</i><br /><br />
</p>
<p>The full course map is here - and can be downloaded:<br />
    <a href="/images/CO24-Course-Map-v3.png" target="_blank"><img src="/images/CO24-Course-Map-v3.png" /></a>
</p>
<h3>Here you can see all the holes one by one:</h3>
<div class="columns-3">
